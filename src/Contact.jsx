...
const Contact = () => {
  return (
    <section className="py-16 px-6 md:px-12 lg:px-20 text-white" id="contact">
      <div className="max-w-4xl mx-auto text-center">
        ...
        {/* Contact Info Card */}
        <div className="bg-gray-900/50 p-6 rounded-xl mb-12 space-y-3 text-gray-300 shadow-lg">
          <p>
        ...
        {/* Embedded Google Map */}
        <div className="w-full h-64 sm:h-80 rounded-xl overflow-hidden shadow-2xl">
          <iframe
